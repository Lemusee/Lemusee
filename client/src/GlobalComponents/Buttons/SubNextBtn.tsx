...
export const Button = styled.button`
  ...
  margin-top: 18px;
  path {
    stroke: ${props=>props.theme.lemuseeblack_60};
  }
  ${T.Pretendard13R} {
...
function SubNextBtn ({name, type, onClick}:IButtonName) {
  return (
    <>
      <Button type={type} onClick={onClick}>
        <T.Pretendard13R>{name}</T.Pretendard13R>
